    ...
    return (
        ...
        >
            <div className="relative max-w-6xl mx-auto flex flex-col lg:flex-row gap-6 sm:gap-8 md:gap-10 lg:gap-20 items-center">
                ...
                <div className="w-full lg:w-1/2 flex flex-col items-center pt-6 sm:pt-8 md:pt-12 lg:pt-20">
                    {/* h2 */}
                    ...
                    {/* Button */}
                    <button className="bg-gradient-to-r from-[#303231] to-[#818F85] text-white px-4 sm:px-6 md:px-8 py-2 sm:py-2.5 md:py-3 shadow-lg text-sm xs:text-base sm:text-lg md:text-xl rounded hover:opacity-90 transition duration-300">
