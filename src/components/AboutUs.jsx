...
const AboutUs = () => {
    return (
        <section id="about" className="bg-white py-8 xs:py-10 sm:py-12 md:py-20 px-2 xs:px-4 md:px-6">
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 xs:gap-8 md:gap-12 items-center">
                ...
                {/* Text */}
                <div>
                    <h2 className="text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold mb-2 xs:mb-4 md:mb-6">ABOUT US</h2>
