...
const Hero = () => {
    return (
        <section
            id="home"
            className="relative min-h-[60vh] sm:min-h-[70vh] md:min-h-screen
                        w-full bg-cover overflow-hidden bg-center flex flex-col md:flex-row  items-center md:items-stretch"
            style={{ backgroundImage: "url('/images/Hero.png')" }}
        >
            {/* Gradient background with 35% width and full height */}
            <div
                className="w-full md:w-[35%] bg-gradient-to-r from-[#5A4D43]
                    to-transparent flex flex-col justify-center px-2 xs:px-4 md:pl-[100px]
                    py-8 md:py-0 z-10 min-h-[60vh] sm:min-h-[70vh] md:min-h-screen"
            >
                <div className="text-white font-['Hammersmith_One'] text-center md:text-left">
                    ...
                    <div
                        className="w-full max-w-[200px] mx-auto md:mx-0 h-[38px] xs:h-[40px]
                            bg-[#CDB7A7] text-[#252926] shadow flex items-center justify-center
                            font-semibold text-[13px] xs:text-[16px] leading-[19px] hover:text-red-600
